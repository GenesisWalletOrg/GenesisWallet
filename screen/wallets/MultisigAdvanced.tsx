  ...
  return (
    <View style={styles.rowCenter}>
      <View style={styles.column}>
        ...
        >
          <Icon name="chevron-up" size={22} type="font-awesome-5" color={n === m || m === 7 ? colors.buttonDisabledTextColor : '#F7931A'} />
        </Pressable>
        ...
        <Pressable
          ...
          style={({ pressed }) => [pressed && styles.pressed, styles.chevron]}
        >
          <Icon name="chevron-down" size={22} type="font-awesome-5" color={m === 2 ? colors.buttonDisabledTextColor : '#F7931A'} />
        </Pressable>
      </View>
      ...
      <View style={styles.column}>
        <Pressable
          ...
          style={({ pressed }) => [pressed && styles.pressed, styles.chevron]}
        >
          <Icon name="chevron-up" size={22} type="font-awesome-5" color={n === 7 ? colors.buttonDisabledTextColor : '#F7931A'} />
        </Pressable>
        ...
        <Pressable
          ...
          testID="DecreaseN"
        >
          <Icon name="chevron-down" size={22} type="font-awesome-5" color={n === m ? colors.buttonDisabledTextColor : '#F7931A'} />
        </Pressable>
      </View>
    </View>
  );
