...
const About: React.FC = () => {
  ...
  const handleOnTwitterPress = () => {
    Linking.openURL('https://x.com/bitcoiniiorg');
  };

  const handleOnDiscordPress = () => {
    Linking.openURL('https://discord.com/invite/zUSkQHNVyG');
  };

  const handleOnTelegramPress = () => {
    Linking.openURL('https://t.me/+mc19GB_d5yo3Yjg5');
  };

  const handleOnGithubPress = () => {
    Linking.openURL('https://github.com/GenesisWalletOrg');
  };

  const handleOnRatePress = () => {
    const options = {
      AppleAppID: '1376878040',
      GooglePackageName: 'org.bitcoinii.genesiswallet',
      preferredAndroidMarket: AndroidMarket.Google,
      preferInApp: Platform.OS !== 'android',
      openAppStoreIfInAppFails: true,
      fallbackPlatformURL: 'https://bitcoin-ii.org',
    };
  ...
  return (
    <SafeAreaScrollView testID="AboutScrollView" contentInsetAdjustmentBehavior="automatic" automaticallyAdjustContentInsets>
      ...
      <BlueTextCentered>Genesis Wallet v0.1.0 - March 7th 2026</BlueTextCentered>
