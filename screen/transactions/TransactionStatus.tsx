              ...
              <View style={styles.center}>
                <Text style={[styles.value, stylesHook.value]} selectable>
                  ...
                  {wallet?.preferredBalanceUnit !== BitcoinUnit.LOCAL_CURRENCY && wallet && (
                    <Text style={[styles.valueUnit, stylesHook.valueUnit]}>{loc.units[wallet.preferredBalanceUnit as keyof typeof loc.units] ?? wallet.preferredBalanceUnit}</Text>
                  )}
                </Text>
              </View>
              ...
              {tx.fee && (
                <View style={styles.fee}>
                  <BlueText style={styles.feeText}>
                    ...
                    {wallet?.preferredBalanceUnit !== BitcoinUnit.LOCAL_CURRENCY && (loc.units[wallet?.preferredBalanceUnit as keyof typeof loc.units] ?? wallet?.preferredBalanceUnit)}
                  </BlueText>
                </View>
              )}
