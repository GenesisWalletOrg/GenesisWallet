...
describe('BlueElectrum', () => {
  ...
  it('ElectrumClient can test connection', async () => {
    assert.ok(!(await BlueElectrum.testConnection('infra1.bitcoin-ii.org', 444, false)));
    assert.ok(!(await BlueElectrum.testConnection('infra1.bitcoin-ii.org', false, 444)));
    ...
    assert.ok(await BlueElectrum.testConnection('infra1.bitcoin-ii.org', '50008'));
    assert.ok(await BlueElectrum.testConnection('infra1.bitcoin-ii.org', false, 50009));
  });
